        ...
        <div className="ourservices--container">
            ...
            <div data-aos="fade-up" className="ourservices--gridContainer">
                ...
                <div className="image-container" onClick={() => openModal(
                    ...
                    <img className="ourservices--gridImg" src="https://github.com/ebunnn/oloricatering/blob/main/src/Images/catering.jpg?raw=true" alt="Catering image"/>
                 ...
                 <div className="image-container" onClick={() => openModal("Experience the vibrant \
                    ...
                    <img className="ourservices--gridImg" src="https://github.com/ebunnn/oloricatering/blob/main/src/Images/africanCuisine.jpg?raw=true" alt="Nigerian cuisine image"/>
                ...
                <div className="image-container" onClick={() => openModal(
                    ...
                    <img className="ourservices--gridImg" src="https://github.com/ebunnn/oloricatering/blob/main/src/Images/Designer.jpg?raw=true" alt="Delivery image"/>
